...
export default async function handler(req, res) {
    ...
    try {
        ...
        // Header
        doc.fontSize(24).fillColor('#2563EB').text('ContractAI', { align: 'center' })
        ...
        doc.fontSize(8).fillColor('#9CA3AF')
            .text(
                'Generated by ContractAI • This report is for informational purposes only and does not constitute legal advice.',
        ...
        res.setHeader('Content-Disposition', `attachment; filename="ContractAI_Report_${contract.file_name}.pdf"`)
